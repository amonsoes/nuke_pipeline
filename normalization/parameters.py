...
parser.add_argument('-valsplit', type=float, default=0.9,help='from which percentage [0,1] data should be used for validation')
...
parser.add_argument('-input', default='word', choices=['word', 'char', 'spelling', 'hybrid', 'phonetic'],
...
## NUKE
parser.add_argument('-bypass', action='store_true' , help='bypass the normalizers to only use LUKE')
